    ...
    <ProjectLayout :project="project">
        ...
        <div class="py-12 px-4 grid gap-y-6 gap-x-4 md:grid-cols-2 lg:grid-cols-3">
            ...
            <div v-for="lyric in lyrics" :key="lyric.id" @click="handleShowUpdateModal(lyric)"
                class="bg-gray-50 w-full h-40 text-center px-4 rounded max-w-md flex flex-col items-center justify-center cursor-pointer border-2 border-gray-400 mx-auto hover:bg-gray-100 hover:border-gray-500 transition ease-in-out duration-150">
